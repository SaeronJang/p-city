...
$(function () {
  ...
  function playingMainView(wImg, idx) {
    ...
    wImg.css({ "position": "absolute", "background-position-x": -x, "background-position-y": "center", "background-image": "url('./resource/img/wImg_" + idx + ".jpg')", "width": "20%", "max-height": $(".mvPicContainer"), "background-size-x": "100%", "z-index": "9", "transform": "scale(1)" });
